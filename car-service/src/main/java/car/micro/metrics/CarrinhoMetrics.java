...
public class CarrinhoMetrics {
    ...
    private final Counter carrinhosRecusados;
    ...
    public CarrinhoMetrics(MeterRegistry registry) {
        ...
        this.carrinhosRecusados =
                Counter.builder(
                                "icimento_cart_service_total_carts_rejected"
                        )
                        .description(
                                "Total de carrinhos recusados"
                        )
                        .tag("service", "cart-service")
                        .register(registry);
    }
    ...
    public void incrementarCarrinhosRecusados() {
        carrinhosRecusados.increment();
    }
}